      ...
      <div className="flex flex-col gap-3 xl:flex-row xl:items-center">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <h1 className="text-sm font-semibold text-brand-900 md:text-base">{APP_NAME}</h1>
        ...
        <div className="grid flex-1 grid-cols-1 gap-2 md:grid-cols-[minmax(240px,1fr)_180px_auto_auto] md:items-center xl:ml-6">
          ...
          <select value={currentUser.id} onChange={(e) => setCurrentUser(e.target.value)} className="h-10 rounded-xl border border-slate-200 bg-slate-50 px-3 text-xs font-semibold text-slate-700 outline-none transition focus:border-brand-300 focus:bg-white">
            {users.map((user) => (
